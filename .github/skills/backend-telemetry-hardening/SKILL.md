...
1. Protect ingestion path first.
...
1. Stabilize TimescaleDB pool behavior.
...
1. Enforce Zod boundary validation with fallback protocol.
...
1. Verify with stress and failure drills.
