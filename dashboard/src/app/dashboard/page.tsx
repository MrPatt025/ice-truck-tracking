      ...
      <header className='sticky top-0 z-50 border-b border-white/10 bg-slate-900/80 backdrop-blur-2xl shadow-lg shadow-black/20'>
        <div className='mx-auto flex max-w-[1800px] items-center justify-between gap-4 px-6 py-4 flex-wrap'>
          <div className='flex items-center gap-4'>
            ...
            <div>
              <p className='text-[10px] uppercase tracking-[.3em] text-slate-400'>
          ...
          <div className='flex items-center gap-3 flex-wrap'>
            ...
            <Pill
              intent={
                apiHealthy ? 'ok' : apiHealthy === false ? 'error' : 'neutral'
              }
            >
              {apiHealthy ? (
      ...
      <main className='mx-auto max-w-[1800px] space-y-8 px-6 py-8'>
                ...
                <GlassCard accent={`from-white/10 via-white/8 to-white/10`}>
                  <div className='rounded-3xl p-6'>
                    <div className='mb-4 flex items-start justify-between'>
                      <div
                        className={`grid h-16 w-16 place-items-center rounded-2xl bg-gradient-to-br ${m.accent} ring-1 ring-white/30 shadow-[0_12px_35px_-12px] shadow-current`}
                      >
                    ...
                    <p className='text-4xl font-bold tracking-tight mt-1 mb-2'>
                      {m.value}
                    </p>
                    <p className='text-xs text-slate-500'>{m.detail}</p>

                    <svg
                      className='mt-4 h-14 w-full opacity-90'
                      viewBox='0 0 300 50'
              ...
              <div className='mb-6 flex items-center justify-between'>
                <div>
                  ...
                  <p className='text-xs text-slate-500 mt-1'>
                    Avg: ${revenueStats.mean.toFixed(0)} | s: $
                    {revenueStats.stdDev.toFixed(0)}
                  </p>
                </div>
                <div className='flex items-center gap-2'>
                  <Pill intent='ok'>
        ...
        <div className='text-center space-y-2 pt-4 pb-8'>
          <div className='flex items-center justify-center gap-4 flex-wrap text-xs text-slate-500'>
            ...
            <span>•</span>
            <span>
              Version: <span className='font-mono text-slate-400'>v2.0.1</span>
            </span>
            <span>•</span>
            <span>
          ...
          <p className='text-xs text-slate-600'>
            © 2024 Fleet Management Pro • Powered by Real-time Analytics Engine
            • All Rights Reserved
          </p>
