  ...
  return {
    ...
    status:
      ...
      record.status === 'alert'
        ...
        : 'offline',
    driverName:
      typeof record.driverName === 'string' ? record.driverName : 'Unknown',
    routeId:
      typeof record.routeId === 'string' ? record.routeId : 'offline-cache',
...
export async function writeFleetSnapshot(
  trucks: readonly TruckTelemetry[]
): Promise<void> {
