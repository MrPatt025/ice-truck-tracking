...
function LoginContent() {
  ...
  }, [email, password, login, clearError, router, redirect]);
  ...
  return (
    ...
    >
      ...
      <div className="text-center mb-8">
        ...
        <p className="text-muted-foreground mt-1">Sign in to your Ice Truck account</p>
      </div>
      ...
      <div className="mt-4 p-3 rounded-lg bg-muted/50 border border-border">
        <p className="text-xs text-muted-foreground text-center">
          Demo: <span className="font-mono">admin@icetruck.com</span> / <span className="font-mono">admin123</span>
        </p>
      </div>
    </motion.div>
  );
