...
test.describe('Dashboard Pages (10)', () => {
    ...
    test('Dashboard page renders with PremiumPageWrapper', async ({
        page,
    }) => {
    ...
    test('Operations page renders with PremiumPageWrapper', async ({
        page,
    }) => {
        await verifyPageLoad(page, '/operations');
    });

    test('Compliance page renders with PremiumPageWrapper', async ({
        page,
    }) => {
