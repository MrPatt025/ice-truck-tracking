-- ใช้ไฟล์นี้เพื่อสร้างตารางสำหรับจัดการเส้นทาง
-- รันคำสั่งนี้ใน MySQL Workbench หรือ command line
...
-- สร้างตารางรายละเอียดเส้นทาง (route_details)
...
-- สร้างตารางการมอบหมายเส้นทางให้รถ (route_assignments)
