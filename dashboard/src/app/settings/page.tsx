          ...
          <div className="flex-1 min-w-0">
            ...
            {tab === 'profile' && (
              ...
              >
                ...
                <div className="flex items-center gap-2">
                  <p className="text-xs text-muted-foreground capitalize">Role: <span className="font-medium text-foreground">{user?.role || 'viewer'}</span></p>
                </div>
              </motion.div>
            )}
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-center justify-between py-3 border-b border-border">
                    ...
                    <button
                      ...
                      className={cn(
                        ...
                        security.twoFactor ? 'bg-green-500' : 'bg-gray-300 dark:bg-gray-600'
                      )}
                    >
                      <span className={cn(
                  ...
                  <div className="flex items-center justify-between py-3 border-b border-border">
                    <div>
                      ...
                      <p className="text-xs text-muted-foreground mt-0.5">Automatically log out after inactivity</p>
                    </div>
                    <select
                  ...
                  <div className="flex items-center justify-between py-3 border-b border-border">
                    <div>
                      ...
                      <p className="text-xs text-muted-foreground mt-0.5">Get notified of new login attempts</p>
                    </div>
                    <button
                      onClick={() => setSecurity(s => ({ ...s, loginAlerts: !s.loginAlerts }))}
                      className={cn(
                        'w-10 h-5 rounded-full relative transition-colors',
                        security.loginAlerts ? 'bg-green-500' : 'bg-gray-300 dark:bg-gray-600'
                      )}
                    >
                      <span className={cn(
                        'absolute top-0.5 w-4 h-4 rounded-full bg-white shadow transition-transform',
                  ...
                  {apiKeys.map(key => (
                    <div key={key.id} className="flex items-center justify-between p-4 rounded-lg border border-border">
                      <div>
                        ...
                        <p className="font-mono text-xs text-muted-foreground mt-1">{key.key}</p>
                        <p className="text-xs text-muted-foreground mt-1">Last used: {key.lastUsed} • Created: {key.created}</p>
                      </div>
            ...
            {tab === 'notifications' && (
              ...
              >
                ...
                {[
                  ...
                  { key: 'dailyDigest' as const, label: 'Daily Digest', desc: 'Summary of fleet activity every morning' },
                  { key: 'weeklyReport' as const, label: 'Weekly Report', desc: 'Detailed fleet performance report every Monday' },
            ...
            {tab === 'appearance' && (
              ...
              >
                ...
                <div>
                  <p className="font-medium text-sm mb-3">Dashboard Density</p>
