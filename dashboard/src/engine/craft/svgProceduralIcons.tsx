...
export const ICON_PATHS = {
  truck:
    'M1 3h15v13H1zM16 8h4l3 3v5h-7V8zM5.5 18.5a2 2 0 100-4 2 2 0 000 4zM18.5 18.5a2 2 0 100-4 2 2 0 000 4z',
...
export const CraftIcon: React.FC<
  Omit<ProceduralIconProps, 'path'> & { name: IconName }
> = ({ name, ...props }) => {
