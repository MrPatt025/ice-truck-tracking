          ...
          >
            <main className='relative z-50 mx-auto max-w-[1500px] space-y-6 p-4 lg:p-6'>
              <motion.header
                ...
                className='relative overflow-hidden rounded-2xl border border-white/10 bg-slate-900/40 p-6 backdrop-blur-xl'
              >
              ...
              <motion.section
                ...
                className='min-h-[340px] rounded-2xl border border-white/10 bg-slate-900/40 p-6 backdrop-blur-xl'
              >
                ...
                <p className='mt-2 text-sm text-slate-300'>
                  Shared-canvas map scene remains mounted behind this panel
                  while corridor overlays update via transient telemetry
                  subscriptions.
                </p>
