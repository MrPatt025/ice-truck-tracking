...
export default function GlassPanel({
  ...
  return (
    <motion.div
      ...
      className={`relative overflow-hidden rounded-3xl border border-cyan-100/25 bg-white/10 backdrop-blur-xl saturate-150 shadow-[0_24px_80px_-42px_rgba(56,189,248,0.72)] ring-1 ring-cyan-200/20 transform-gpu ${className}`}
    >
