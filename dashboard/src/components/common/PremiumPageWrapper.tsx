  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className={cn(
          mode === 'glass' &&
            'premium-surface relative z-50 overflow-hidden rounded-3xl border border-white/10 bg-slate-900/30 shadow-[0_8px_32px_0_rgba(0,0,0,0.4)] backdrop-blur-3xl text-slate-50 supports-[backdrop-filter]:backdrop-saturate-150',
          contentClassName
        )}
        style={{ contain: 'layout style paint' }}
      >
