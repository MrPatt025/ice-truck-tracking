                  ...
                  <div className='flex flex-wrap items-center justify-between gap-3 pb-4 border-t border-white/5 pt-3'>
                    ...
                    <div className='flex items-center gap-3'>
                      <div className='flex items-center gap-1 rounded-xl p-1 bg-white/5 ring-1 ring-white/10'>
                        {(['dark', 'neon', 'ocean', 'forest'] as const).map(
                          t => (
                            <button
                              key={t}
                              onClick={() => setTheme(t)}
              ...
              >
                      ...
                      <div className='rounded-3xl p-6'>
                        ...
                        <div className='mt-6 grid grid-cols-2 gap-3'>
                          <div className='text-center p-3 rounded-xl bg-emerald-500/10 ring-1 ring-emerald-500/30'>
                            ...
                            <p className='text-3xl font-extrabold tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-white to-slate-400 text-emerald-400'>
                              90.2
                            </p>
                          </div>
                          <div className='text-center p-3 rounded-xl bg-cyan-500/10 ring-1 ring-cyan-500/30'>
                            <p className='text-xs text-slate-400'>Rank</p>
                            <p className='text-3xl font-extrabold tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-white to-slate-400 text-cyan-400'>
                              #1
                            </p>
                          </div>
                        </div>
                            ...
                            <>
                              ...
                              <div className='absolute inset-0 flex items-center justify-center backdrop-blur-sm'>
                                <div className='text-center space-y-4'>
                                  ...
                                  <p className='text-3xl font-extrabold tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-white to-slate-400'>
                ...
                <div className='text-center space-y-2 pt-4 pb-8'>
                  <div className='flex items-center justify-center gap-4 flex-wrap text-xs text-slate-500'>
                    ...
                    <span>
                      Build:{' '}
                      <span className='font-mono text-slate-400'>#4523</span>
                    </span>
                    <span>•</span>
                    <span>
                      Uptime:{' '}
              ...
              {fullscreen && (
                <div className='fixed inset-0 z-[100] bg-slate-950/90 backdrop-blur-xl animate-fadeIn'>
                  <div className='absolute inset-4 lg:inset-10 rounded-3xl ring-1 ring-white/20 bg-slate-900/80 backdrop-blur-xl p-4 lg:p-8 shadow-2xl'>
                    <div className='mb-4 flex items-center justify-between'>
                      <h3 className='text-xl lg:text-3xl font-extrabold tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-white to-slate-400'>
