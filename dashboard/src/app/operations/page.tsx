          ...
          >
            <main className='relative z-50 mx-auto max-w-[1500px] space-y-6 p-4 lg:p-6'>
              ...
              >
                ...
                <h1 className='flex items-center gap-3 text-4xl font-extrabold tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-white to-slate-400 text-slate-50'>
                  <RadioTower className='h-7 w-7 text-teal-300' />
                  Operations Pulse
                </h1>
                <p className='mt-2 text-sm leading-6 text-slate-300'>
                  Unified ingestion and transport signal wall built for incident
                  triage, render-stable at all breakpoints, and tuned for
              ...
              <section className='grid gap-4 md:grid-cols-2 xl:grid-cols-4'>
                {OPS_STREAMS.map((stream, idx) => (
                  ...
                  >
                    ...
                    <p className='mt-2 inline-flex rounded-full border border-white/10 px-2 py-1 text-xs text-slate-200'>
                      {stream.status}
                    </p>
                  </motion.article>
                ))}
