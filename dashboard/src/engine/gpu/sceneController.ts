...
const getDevicePixelRatio = () => globalThis.window?.devicePixelRatio ?? 1
...
export class SceneController {
  ...
  private lastCullResult: CullResult = {
    visibleCount: 0,
    totalCount: 0,
    culledCount: 0,
  }
  ...
  private readonly animationCallbacks: Map<string, (dt: number) => void> =
    new Map()
   ...
   */
  cullInstances(positions: Float32Array, count: number): Uint8Array {
