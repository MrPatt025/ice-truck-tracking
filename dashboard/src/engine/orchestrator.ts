...
export function bootEngine(config?: Partial<WorkerConfig>): void {
  ...
  try {
    ...
    console.warn(
      '[IoT Engine] Worker init failed, running in-thread fallback:',
      err
    )
  }
  ...
  if (process.env.NODE_ENV === 'development')
    console.debug('[IoT Engine] Booted with Masterpiece Architecture ✓')
  ...
  if (process.env.NODE_ENV === 'development')
    console.debug('[IoT Engine] Craft Layer v5.0 mounted ✓')
}
...
export function shutdownEngine(): void {
  ...
  if (process.env.NODE_ENV === 'development')
    console.debug('[IoT Engine] Shutdown ✓')
}
...
export function registerCinematicWorkerWithMap(
  cinematicWorker: Worker | null
): void {
  if (mapLayer) {
...
export function getLightDirector(): LightDirector | null {
  return lightDirector
}
export function getTextureCompositor(): TextureCompositor | null {
  return textureCompositor
}
export function getCursorPhysics(): CursorPhysicsEngine | null {
  return cursorPhysics
}
export function getCinematicScroll(): CinematicScrollEngine | null {
  return cinematicScroll
}
export function getMicroInteractions(): MicroInteractionController | null {
  return microInteractions
}
export function getTemporalUI(): TemporalUIEngine | null {
  return temporalUI
}
export function getPredictiveRenderer(): PredictiveRenderer | null {
  return predictiveRenderer
}
export function getParticleSystem(): ParticleMicroSystem | null {
  return particleSystem
}
export function getSceneGraph(): SceneGraphController | null {
  return sceneGraph
}
export function getMapVisuals(): MapVisualController | null {
  return mapVisuals
}
export function getVisualSilence(): VisualSilenceController | null {
  return visualSilence
}
export function getBudgetGovernor(): AnimationBudgetGovernor | null {
  return budgetGovernor
}
export function getColorIntelligence(): ColorIntelligenceEngine | null {
  return colorIntelligence
}
export function getLayoutDensity(): LayoutDensityController | null {
